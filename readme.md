...
2. Download the ZIP source code of [this repository](../../archive/refs/heads/master.zip).  
   i.e. Click **`Code > Download ZIP`** above.

3. Extract the ZIP to a location on your computer.

4. Open the extracted folder and run `setup.cmd` to set up the environment for running the script.
